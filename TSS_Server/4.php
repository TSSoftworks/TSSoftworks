...
<html lang = "es">
	...
	<body> 
		...
		<div id = "Parrafo">
				<span class = "Title"><center>¡AVISO!</center></span></br>
				<div id = "slogan">Los juegos aqui presentes son versiones en desarrollo y pueden presentar problemas tipicos de un juego en etapa temprana. Te invitamos a reportar los bugs que encuentres a nuestro correo para que asi, con el compromiso que nos carazteriza, brindarte una mejor experiencia</div>
			</div>
			...
			<div id = "Main">
				...
				<span class = "article">
					...
					<section class = "seccion">
						<img src = "Media/Imagenes/cs.png" id = "P01"/>

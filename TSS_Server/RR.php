...
<html lang = "es">
	...
	<body> 
			...
			<div id = "Main">
				<span class = "article">
					...
					<section class = "seccion">
						<img src = "Media/Imagenes/Publicidad1.png" id = "P01"/>
				...
				<span class = "article">
					...
					<section class = "seccion">
						<video  id = "P01" autoplay loop muted><source src = "Media/ComercialRR.mp4" type="video/mp4"/></video>
				...
				<span class = "article">
					...
					<section class = "seccion">
						<img src = "Media/Imagenes/AntologiaG.png" id = "P01"/>
				...
				<span class = "article">
					...
					<section class = "seccion">
						<img src = "Media/Imagenes/ChangoT-Pose.png" id = "P01"/>
		...
		<div id = "Parrafo">
				<span class = "Title">¡Bienvenidos la Web Oficial de Team Salchicha!</span></br>
				<p>Aquí estaremos publicando avances, demos, blogs y demás temas relacionados a nuestros juegos, así que si te enganchaste navegando por la aleatoriedad de nuestros juegos puedes sentarte por aquí a esperar mas mundos random mientras tomas un café. Siéntete libre de dar feedback y comentarios sobre nuestros proyectos, la critica, constructiva o no nos hará mas fuertes.<p>
			</div>
			
			<div id = "tw"><a class="twitter-timeline" data-width="350" data-height="500" data-theme="dark" href="https://twitter.com/team_salchicha?ref_src=twsrc%5Etfw">Tweets by team_salchicha</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> </div>
